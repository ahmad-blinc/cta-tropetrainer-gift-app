...
export default function CertificateDesign() {
  ...
  const verifyWidgetAppUrl = certificateLinkParts.appUrl;
        ...
        <div style={fullBleedStyle}>
          <Card padding="0">
            <Tabs tabs={tabs} selected={selectedTab} onSelect={setSelectedTab} fitted>
              ...
              {selectedTab === 6 && (
                <Box padding="400">
                  <VerifyWidgetTab appUrl={verifyWidgetAppUrl} />
                </Box>
              )}
            </Tabs>
          </Card>
...
function VerifyWidgetTab({ appUrl }: { appUrl: string }) {
